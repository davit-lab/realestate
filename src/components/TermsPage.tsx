...
const SECTIONS = [
 ...
 body: `newlife.ge (შემდგომში "პლატფორმა") წარმოადგენს უძრავი ქონების ონლაინ-პლატფორმას, რომელიც უზრუნველყოფს განცხადებების განთავსებასა და მოძიებას საქართველოში. პლატფორმით სარგებლობით, თქვენ ეთანხმებით წინამდებარე წესებსა და პირობებს.`,
 },
 {
 ...
 body: `პლატფორმაზე განთავსებული ფოტოები და ტექსტი რჩება მომხმარებლის საკუთრებაში, თუმცა განთავსებით ის ანიჭებს newlife.ge-ს კონტენტის გამოყენების, ჩვენებისა და ასლების შექმნის არაექსკლუზიურ, უსასყიდლო ლიცენზიას.`,
 },
 {
 title: '6. პასუხისმგებლობის შეზღუდვა',
 body: `newlife.ge მოქმედებს როგორც შუამავალი პლატფორმა. ჩვენ პასუხს არ ვაგებთ:\n• მომხმარებლებს შორის გარიგებებზე;\n• განცხადებებში მოწოდებული ინფორმაციის სიზუსტეზე;\n• სხვა მომხმარებლების მოქმედებებზე.`,
 },
 {
 title: '7. ანგარიშის გაუქმება',
 body: `newlife.ge-ს უფლება აქვს გააუქმოს ანგარიში წინამდებარე წესების დარღვევის, სასამართლო გადაწყვეტილების ან უსაფრთხოების საფრთხის შემთხვევაში. მომხმარებელს შეუძლია ნებისმიერ დროს წაშალოს ანგარიში პარამეტრების გვერდიდან.`,
 },
 {
 title: '8. ცვლილებები',
