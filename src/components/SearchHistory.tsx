...
export default function SearchHistory({ history, onSelect, onRemove, onClear }: SearchHistoryProps) {
 ...
 <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
  ...
  <div className="flex items-center gap-2">
   ...
   <span className="text-[11px] font-semibold text-gray-500 uppercase tracking-wider">ბოლოს ძიება</span>
  </div>
  <button
   onClick={onClear}
  ...
  <AnimatePresence>
   ...
   <motion.button
    ...
    className="w-full group flex items-center gap-3 p-2.5 rounded-xl hover:bg-gray-50 :bg-gray-800 transition-colors text-left cursor-pointer"
   >
