...
export default function SidebarFilter({
 ...
 const inp = 'w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-[9px] text-sm text-gray-800 focus:outline-none focus:border-ss-primary focus:bg-white :bg-gray-800 transition-colors';
 ...
 <div className="w-full lg:w-64 xl:w-72 flex flex-col gap-3">
  ...
  <div className="p-2 flex flex-col gap-1">
   ...
   className={`w-full py-2 rounded-lg text-sm font-semibold transition-colors cursor-pointer text-center ${
    selectedType === 'all' ? 'bg-ss-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 :bg-gray-700'
   }`}
   >
   ყველა განცხადება
   </button>
   ...
   {typeLabels.filter(t => t.value !== 'all').map(({ value, label }) => (
    ...
    className={`py-2 rounded-lg text-sm font-medium transition-colors cursor-pointer text-center ${
     selectedType === value ? 'bg-ss-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 :bg-gray-700'
    }`}
    >
    {label}
    </button>
    ...
    <div className="space-y-3">
     ...
     <div>
      ...
      {cityResults.map(l => (
       ...
       className="w-full text-left px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-gray-50 :bg-gray-800 transition-colors flex items-center justify-between">
  ...
  <div className="px-4 py-4 flex flex-col gap-4">
   ...
   <div className="grid grid-cols-4 gap-1">
    ...
    return (
     ...
     className={`py-[7px] text-[12px] font-medium rounded-lg transition-colors cursor-pointer ${
      roomFilter === val ? 'bg-ss-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 :bg-gray-700'
     }`}
     >
     {r}
     </button>
   ...
   <div className="grid grid-cols-2 gap-1">
    ...
    <button key={val} onClick={() => setSelectedStatus(val)}
     className={`py-[7px] text-[12px] font-medium rounded-lg transition-colors cursor-pointer ${
     selectedStatus === val ? 'bg-ss-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 :bg-gray-700'
     }`}
    >
     {label}
    </button>
  ...
  <button onClick={toggleCurrency}
   className="bg-white border border-gray-200 rounded-xl py-2.5 flex items-center justify-center gap-1.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 :bg-gray-800 transition-colors cursor-pointer"
  >
  ...
  <button
   ...
   className="bg-white border border-gray-200 rounded-xl py-2.5 flex items-center justify-center gap-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 :bg-gray-800 transition-colors cursor-pointer"
  >
  ...
  <button onClick={clearAll}
   className="flex items-center justify-center gap-1.5 w-full text-[12px] font-medium text-gray-500 hover:text-red-600 bg-white border border-gray-200 hover:border-red-200 :border-red-800 hover:bg-red-50 :bg-red-900/10 py-2.5 rounded-xl transition-colors cursor-pointer"
  >
   <X size={12} />
